...
import { Pill, User, Mail, Lock, Phone, ArrowLeft, CheckCircle2, Shield } from "lucide-react";
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.user.userType !== 'customer') {
        authService.logout();
        toast.error("This login is for customers only. Please use the delivery partner login.");
        return;
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-teal-50 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-teal-500 rounded-3xl mb-4 shadow-xl transform hover:scale-110 transition-transform duration-300">
          ...
          <div className="flex items-center justify-center gap-2 mt-3">
            ...
            <span className="text-sm text-gray-600">Secure & Fast Medicine Delivery</span>
          </div>
        </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="login" className="space-y-4">
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-12 bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]" 
                    disabled={loading}
                  >
                    {loading ? (
